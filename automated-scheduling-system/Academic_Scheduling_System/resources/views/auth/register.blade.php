...
<head>
    ...
    <title>Register - Academic Scheduling System</title>
            ...
            <div class="col-md-5 col-lg-4">
                <div class="card card-auth p-4 bg-white">
                    <div class="text-center mb-4">
                        ...
                        <p class="text-muted small">Enter your official details to proceed</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="username" class="form-control @error('username') is-invalid @enderror" value="{{ old('username') }}" placeholder="Enter University ID" required autofocus>
                            @error('username') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-bold small">Official Email</label>
                            <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="name@university.edu" required>
                        ...
                        <button type="submit" class="btn btn-university w-100 mb-3">Register</button>
                        
                        <div class="text-center">
                            <span class="text-muted small">Already have an account?</span>
                            <a href="{{ route('login') }}" class="small fw-bold text-decoration-none" style="color: #0056b3;">Login here</a>
                        </div>
                    </form>
                </div>
            </div>

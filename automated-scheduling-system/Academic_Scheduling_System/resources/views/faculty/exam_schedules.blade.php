...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="fw-bold text-dark mb-0">Exam Schedules - {{ $department->name }}</h2>
            <p class="text-muted mb-0">View finalized departmental exam timetables</p>
        </div>
        <a href="{{ route('faculty.dashboard') }}" class="btn btn-outline-success shadow-sm">
    ...
    @if($groups->isEmpty())
        <div class="card border-0 shadow-sm p-5 text-center">
            ...
            <h5 class="text-muted">No locked exam schedules found for this department.</h5>
        </div>
    @else
        <div class="row">
                    ...
                    <div class="card border-0 shadow-sm h-100 border-top border-4 border-info">
                        <div class="card-body p-4">
                            ...
                            <div class="d-grid gap-2">
                                <a href="{{ route('faculty.exam-schedules.show', ['department' => $department->id, 'year' => $group->year, 'semester' => $group->semester, 'section' => $group->section]) }}" 
